...
class Converter:
    def __init__(self):
        ...
        self.temperature_converter_label = Label(self.converter_frame, text="Temperature Converter",
                                                 font=("Arial", "16", "bold"),
                                                 bg=background_color,
                                                 padx=10, pady=10,)
...
class Export:
    ...
    def save_history(self, partner, calc_history):
        ...
        if has_error == "yes":
            ...
            # If there are no errors, generate text file and close dialogue
            # add .txt suffix!
